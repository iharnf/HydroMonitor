...
- ✅ `v0.2.0` — расчёт pH, цветной дисплей, калибровка из даташита
...
| Проблема | Решение |
|----------|---------|
| ADC error 263 (WiFi) | GPIO26 → GPIO36 (ADC2 → ADC1) |
| pH не отображается | Убран blink, калибровка 59→167.5 mV/pH |
| Экран вверх ногами | rotation 180 → 0 |
| Текст налезает | Статус и HYDROPONIC на разных строках |
| Font пропускал символы | Добавлен lowercase a-z в glyphs |
| Дисплей тормозил | update_interval 250ms → 1s, font 68→56 |
